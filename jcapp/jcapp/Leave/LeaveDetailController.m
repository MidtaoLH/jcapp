...
- (void)viewDidLoad {
    ...
    NSString *strPara = [NSString stringWithFormat:@"AppWebService.asmx/GetLeaveDataByID?userID=%@&LeaveID=%@&ProcessInstanceID=%@&iosid=%@", userID,self.awardID_FK,self.processInstanceID,iosid ];
