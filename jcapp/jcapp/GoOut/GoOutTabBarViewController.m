...
#import "GoOutTabBarViewController.h"
...
@interface GoOutTabBarViewController ()

@end

@implementation GoOutTabBarViewController
...
//    [self.tabBar setShadowImage:img];
    ...
    UITabBarItem *item3 = [[UITabBarItem alloc]initWithTitle:@"外出记录" image:[[UIImage imageNamed:@"tabBar_friendTrends_icon.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] tag:0];
    item3.selectedImage = [[UIImage imageNamed:@"tabbar_person_selected"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];


    NSArray *controllers = @[@"GoOutWaitController",@"VatcationMainViewController",@"GoOutViewController"];
    for (int i = 0; i < 3; i++) {
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationItem.title=@"待外出记录";
}
